---
description: Identity and scope of the files skill.
index:
  - Identity
  - Scope
  - Constraints
...
files is a single skill that performs deterministic, auditable file enumeration over a directory tree.
...
files answers which files exist, what types are present, and how the directory tree is structured.
